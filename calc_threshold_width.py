...
# Path to the folder conatining scan files
...
for i in filelist:
    if i.endswith(".json"):
        ...
        if i.startswith("20181010"): #Because only two out of three tdc's were used in my scans.
            tdc_cal = tdc_cal0
        elif i.startswith("20181015_102319"): #Some manipulation required based on the file system for my scans
...
xx = [a for a in range((len(filelist)*32))]
